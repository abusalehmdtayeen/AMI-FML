...
class LocalModel(object):
	...
	def update_weights(self, model, global_round):
		...
		delta_w = get_delta_update(pre_w, new_w)
 
		return delta_w, sum(epoch_loss) / len(epoch_loss)
	...
	def infer_and_update_weights(self, test_index, model, global_round):
		...
		return delta_w, sum(epoch_loss) / len(epoch_loss), actual_predictions, test_predictions
