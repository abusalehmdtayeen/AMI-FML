...
from delta_online_local_model import LocalModel
...
if __name__ == '__main__':
	...
	helper.write_csv(base_path + "/results/delta-online-federated-"+group_type+"-"+gid+"-train-avg-loss-t"+str(test_range), train_loss, ["epoch", "locals_loss_avg"])
	...
	for epoch in range(1):
		...
		print("---------------------------------------------------")
		helper.write_csv(base_path + "/results/delta-online-federated-global-"+group_type+str(gid)+"-t"+str(test_range), global_metrics, ["group_id", "RMSE", "NRMSE", "MAE"])
		#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
		...
		helper.write_csv(base_path + "/results/delta-online-federated-local-"+group_type+str(gid)+"-t"+str(test_range), rmse_list, ["meter_id", "RMSE", "NRMSE", "MAE"])
